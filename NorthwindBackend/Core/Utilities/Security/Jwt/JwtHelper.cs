...
using Core.Utilities.Security.Encrypription;
...
namespace Core.Utilities.Security.Jwt
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public AccessToken CreateToken(User user, List<OperationClaim> operationClaims)
        {
            ...
            var  jwt = CreateSecurityToken(_tokenOptions, user, signingCredentials, operationClaims);
        ...
        public JwtSecurityToken CreateSecurityToken(TokenOptions tokenOptions, User user, SigningCredentials signingCredentials,
